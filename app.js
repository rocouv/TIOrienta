const questions = [
  { kicker: "PARA EMPEZAR", title: "Cuando aprendes algo nuevo, ¿qué te produce más satisfacción?", answers: [
    ["Ver cómo otra persona lo entiende gracias a tu explicación", "teaching"], ["Descubrir cómo funciona por dentro", "backend"], ["Encontrar patrones que otros no ven", "data"], ["Hacer que una herramienta sea más fácil de usar", "ux"] ] },
  { kicker: "TU ENERGÍA", title: "En un proyecto, ¿qué papel sueles asumir naturalmente?", answers: [
    ["Acompañar, organizar y mantener al equipo enfocado", "teaching"], ["Resolver el problema difícil que nadie quiere tocar", "backend"], ["Poner orden en la información y tomar decisiones", "data"], ["Escuchar a las personas y mejorar su experiencia", "ux"] ] },
  { kicker: "TU CURIOSIDAD", title: "¿Qué te gustaría poder crear o mejorar?", answers: [
    ["Clases y recursos para que otros ganen confianza", "teaching"], ["Una interfaz web que otras personas puedan usar", "frontend"], ["Un reporte que ayude a entender qué está pasando", "data"], ["La forma en que una persona interactúa con un producto", "ux"] ] },
  { kicker: "EN LA PRÁCTICA", title: "Algo deja de funcionar. ¿Qué haces primero?", answers: [
    ["Pregunto qué estaba intentando hacer la persona", "support"], ["Investigo, pruebo hipótesis y busco la causa", "backend"], ["Reviso los datos para confirmar cuándo y cómo ocurre", "data"], ["Observo el recorrido para detectar dónde se confunde", "frontend"] ] },
  { kicker: "LO QUE VALORAS", title: "¿Qué tipo de impacto te gustaría dejar con tu trabajo?", answers: [
    ["Que alguien diga: ‘ahora sí lo puedo hacer’", "teaching"], ["Construir algo útil que antes no existía", "backend"], ["Convertir información en decisiones más inteligentes", "data"], ["Hacer que el día a día de otros sea más simple", "support"] ] },
  { kicker: "TU ESTILO", title: "¿Qué frase te representa mejor?", answers: [
    ["Tengo paciencia para explicar las cosas de varias maneras", "teaching"], ["Me gusta experimentar hasta que algo funciona", "frontend"], ["Los detalles y la lógica me ayudan a ver el panorama", "data"], ["Siempre encuentro una forma más clara de organizarlo", "ux"] ] },
  { kicker: "TU ENTORNO IDEAL", title: "¿En qué situación te sentirías más útil?", answers: [
    ["Guiando un taller de ofimática o programación", "teaching"], ["Creando soluciones con código y herramientas digitales", "backend"], ["Analizando resultados para proponer el siguiente paso", "data"], ["Ayudando a alguien a resolver un reto técnico", "support"] ] },
  { kicker: "PARA CERRAR", title: "Si tuvieras una tarde libre para explorar TI, ¿qué elegirías?", answers: [
    ["Preparar una mini clase para compartirla", "teaching"], ["Seguir un tutorial y construir un proyecto", "frontend"], ["Jugar con una hoja de cálculo y sacar conclusiones", "data"], ["Rediseñar una pantalla para que se entienda mejor", "ux"] ] }
];
